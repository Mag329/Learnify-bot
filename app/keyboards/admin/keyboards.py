...
panel = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="Уведомление об обновление", callback_data="update_notification")],
...
confirm_update_notification = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="Отправить", callback_data="send_update_notification")],
        [InlineKeyboardButton(text="Отменить", callback_data="cancel_update_notification")]
    ]
)