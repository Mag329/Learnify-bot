...
async def send_update_notification_handler(callback: CallbackQuery, state: FSMContext, bot: Bot):
    await callback.answer()
...
async def cancel_update_notification_handler(callback: CallbackQuery, state: FSMContext):
    await callback.answer()
